...
function HomeIcon({ color }) {
  return (
    <svg width="26" height="26" viewBox="0 0 100 100" fill="none"
      ...
      <polyline points="10,48 50,12 90,48"/>
      <rect x="20" y="48" width="60" height="42" rx="2"/>
      <rect x="38" y="68" width="24" height="22" rx="2"/>
      <rect x="26" y="56" width="18" height="16" rx="1.5"/>
      <line x1="35" y1="56" x2="35" y2="72"/>
      <line x1="26" y1="64" x2="44" y2="64"/>
      <rect x="56" y="56" width="18" height="16" rx="1.5"/>
      <line x1="65" y1="56" x2="65" y2="72"/>
      <line x1="56" y1="64" x2="74" y2="64"/>
    </svg>
  );
}
...
function ProgressIcon({ color }) {
  return (
    <svg width="26" height="26" viewBox="0 0 100 100" fill="none"
      ...
      <rect x="14" y="68" width="18" height="20" rx="2"/>
      <rect x="41" y="48" width="18" height="40" rx="2"/>
      <rect x="68" y="22" width="18" height="66" rx="2"/>
    </svg>
  );
}
...
function ChallengesIcon({ color }) {
  return (
    <svg width="26" height="26" viewBox="0 0 100 100" fill="none"
      stroke={color} strokeWidth="5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M28,14 L72,14 L72,48 Q72,72 50,72 Q28,72 28,48 Z"/>
      <path d="M28,22 Q10,22 10,38 Q10,54 28,54"/>
      <path d="M72,22 Q90,22 90,38 Q90,54 72,54"/>
      <rect x="44" y="72" width="12" height="10" rx="1"/>
      <rect x="30" y="82" width="40" height="8" rx="3"/>
      <path d="M50,28 L53,36 L62,36 L55,42 L58,50 L50,45 L42,50 L45,42 L38,36 L47,36 Z" strokeWidth="3"/>
    </svg>
  );
}
...
function ProfileIcon({ color }) {
  return (
    <svg width="26" height="26" viewBox="0 0 100 100" fill="none"
      ...
      <path d="M14,92 C14,70 86,70 86,92"/>
    </svg>
  );
}
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-slate-900 to-blue-950">
      ...
      {!hideNavigation && (
        <nav className="hidden md:flex fixed left-0 top-0 bottom-0 w-20 bg-slate-900/95 backdrop-blur-xl border-r border-blue-800/50 flex-col items-center py-8 z-50 shadow-xl">
          <Link to={createPageUrl('Gyms')} className="mb-8" style={{ WebkitTapHighlightColor: 'transparent', outline: 'none', background: 'none' }}>
