...
import { Dumbbell, Crown, MessageCircle, Bell, Building2, Home, Gift, BarChart3, ClipboardList, CalendarDays, UserCheck, UserPlus, CalendarPlus } from 'lucide-react';
...
function LayoutInner({ children, currentPageName, currentUser, notifications, gymMemberships, isDashboardUser, isCoachUser, hideNavigation }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-slate-900 to-blue-950">
      ...
      {/* Bottom Navigation */}
      {!hideNavigation &&
      <nav className="fixed bottom-0 left-0 right-0 bg-slate-900/95 backdrop-blur-xl border-t-0 z-50 md:hidden shadow-none pb-[env(safe-area-inset-bottom)]">
