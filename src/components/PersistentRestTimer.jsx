...
export default function PersistentRestTimer({ isActive, restTimer, initialRestTime, onTimerStateChange, onTimerValueChange }) {
  ...
  return (
    <>
      ...
      {/* Persistent Bar */}
      {!expanded &&
      <div className="fixed left-0 right-0 z-400 bg-gradient-to-r from-blue-700/95 to-blue-900/95 backdrop-blur-2xl border border-blue-600/50 p-3.5 shadow-2xl shadow-blue-900/20 cursor-pointer\n"
