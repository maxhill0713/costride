      ...
      {open && (
        <>
          ...
          >
            ...
            <div style={{ padding: '24px 24px max(24px, env(safe-area-inset-bottom))', maxHeight: 'calc(85vh - 60px)', overflowY: 'auto', WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none', display: 'flex', flexDirection: 'column' }}>
              {/* Success icon */}
