    ...
    <div className="space-y-3">
      ...
      <motion.div
        ...
        transition={{ duration: 0.3, repeat: isChecking ? Infinity : 0 }}>
          ...
          disabled={isChecking} className="inline-flex items-center justify-center gap-2 whitespace-nowrap focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 text-white px-4 py-2 w-full h-14 rounded-2xl font-bold text-base bg-orange-500 border-b-[6px] border-orange-700 hover:bg-orange-400 hover:border-orange-600 active:border-b-2 active:translate-y-1 transition-all duration-100\n">
