    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      <button
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <div style={{ width: 28, height: 28, borderRadius: 9, background: 'linear-gradient(135deg, rgba(250,204,21,0.2), rgba(251,146,60,0.1))', border: '1px solid rgba(250,204,21,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
