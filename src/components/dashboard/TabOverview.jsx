...
function Sidebar() {
  return (
    <div style={{
      width: 176, flexShrink: 0, background: C.sidebar,
      borderRight: `1px solid ${C.divider}`,
      display: 'flex', flexDirection: 'column',
      height: '100vh', position: 'sticky', top: 0,
    }}>
      {/* Logo */}
      <div style={{ padding: '18px 16px 22px', display: 'flex', alignItems: 'center', gap: 9 }}>
        <div style={{
          width: 32, height: 32, borderRadius: 9,
          background: 'linear-gradient(135deg, #00e5c8, #0891b2)',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
        }}>
          <span style={{ fontSize: 16, fontWeight: 800, color: '#000' }}>🔥</span>
        </div>
        <div>
          <div style={{ fontSize: 13, fontWeight: 700, color: C.t1, lineHeight: 1.15 }}>Forge</div>
      ...
      <div style={{ padding: '10px 10px 18px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '8px 10px', cursor: 'pointer' }}>
          ...
          <span style={{ fontSize: 13, color: C.t2 }}>Settings</span>
        </div>
      </div>
    </div>
  );
...
function TopBar() {
  return (
    <div style={{
      height: 52, background: C.topbar, borderBottom: `1px solid ${C.divider}`,
      display: 'flex', alignItems: 'center', gap: 14, padding: '0 22px',
      flexShrink: 0,
    }}>
      <span style={{ fontSize: 13.5, fontWeight: 600, color: C.t1, whiteSpace: 'nowrap' }}>
        Gym Owner Dashboard
      </span>

      <div style={{
        flex: 1, maxWidth: 300, display: 'flex', alignItems: 'center', gap: 8,
        background: 'rgba(255,255,255,0.04)', border: `1px solid ${C.divider}`,
        borderRadius: 8, padding: '6px 12px',
      }}>
        <Search style={{ width: 13, height: 13, color: C.t3 }} />
      ...
      <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 10 }}>
        <div style={{
          ...
          background: 'rgba(255,255,255,0.04)', border: `1px solid ${C.divider}`,
          borderRadius: 8, fontSize: 12, color: C.t2,
        }}>
        ...
        <button style={{
          ...
          borderRadius: 8, fontSize: 12, fontWeight: 600, color: C.cyan,
