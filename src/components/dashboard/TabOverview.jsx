...
function DesktopOverview({
  ...
  return (
    <div style={{ fontFamily: FONT, display: 'flex', flexDirection: 'column', gap: 11, background: '#000', height: 'calc(100vh - 80px)', boxSizing: 'border-box', paddingBottom: 32, overflow: 'hidden' }}>
