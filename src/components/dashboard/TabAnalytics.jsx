...
return (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 7 }}>
                ...
                <div style={{ flex: 1, height: 16, background: C.brd, borderRadius: 3, overflow: "hidden", position: "relative" }}>
                  ...
                  {isPeak && (
                    <span style={{ position: "absolute", right: 5, top: "50%", transform: "translateY(-50%)", fontSize: 8, color: "#fff", fontWeight: 700 }}>PEAK</span>
                  )}
                </div>
...
Analytics <span style={{ color: C.t3, fontWeight: 300 }}>/</span>{" "}
          ...
          <div style={{ fontSize: 10.5, color: C.t3, marginTop: 2 }}>Retention, engagement and revenue — at a glance</div>
        </div>
        <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: isMobile ? "flex-start" : "center", gap: 9, width: isMobile ? "100%" : "auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 5, padding: "5px 10px", borderRadius: 7, background: C.amberD, border: `1px solid ${C.amberB}`, fontSize: 11, color: C.amber, fontWeight: 600, width: isMobile ? "100%" : "auto", boxSizing: "border-box" }}>
      ...
      <div style={{ paddingBottom: 24 }}>
        <div style={{ fontSize: 9.5, fontWeight: 700, color: C.t3, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 9 }}>Revenue</div>
