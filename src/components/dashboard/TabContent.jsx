...
return (
    <div style={{ width: 252, flexShrink: 0, background: C.sidebar, borderLeft: `1px solid ${C.brd}`, padding: "14px 12px", display: "flex", flexDirection: "column", gap: 14, overflowY: "auto" }}>
      ...
      <div style={{ height: 1, background: C.brd }} />
      <div>
        <button onClick={() => openModal?.("post")} style={{ width: "100%", padding: "9px", borderRadius: 8, background: C.cyan, color: "#fff", border: "none", fontSize: 12.5, fontWeight: 700, cursor: "pointer", fontFamily: FONT, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, boxShadow: "0 0 10px rgba(77,127,255,0.22), 0 2px 6px rgba(77,127,255,0.12)" }}>
...
return (
      ...
      {!isMobile && <RightSidebar events={events} challenges={challenges} polls={polls} posts={posts} openModal={openModal} />}
      {/* Mobile FAB + menu */}
      {isMobile && (
        <>
