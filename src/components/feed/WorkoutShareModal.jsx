      ...
      {open && (
        <>
          ...
          >
            ...
            {/* Header — no X button, tap backdrop to close */}
              ...
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <div
                  ...
                  style={{
                    ...
                    overflow: 'hidden', borderRadius: 14, touchAction: 'pan-y',
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 8, flexShrink: 0 }}>
              {cards.map((card, i) => (
                <button key={i} onClick={() => setActiveCard(i)} style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', padding: 4 }}>
                  <div style={{ width: activeCard === i ? 18 : 6, height: 6, borderRadius: 3, background: activeCard === i ? 'white' : 'rgba(255,255,255,0.20)', transition: 'all 0.24s cubic-bezier(0.34,1.56,0.64,1)' }} />
                </button>
              ))}
            </div>
            ...
            <div style={{ padding: '12px 18px 0', flexShrink: 0 }}>
              ...
              <div style={{ display: 'flex', gap: 12, overflowX: 'auto', WebkitOverflowScrolling: 'touch', paddingBottom: 2 }}>
                {APP_BUTTONS.map((btn) => (
                  <button
                    key={btn.id} onClick={() => handleBtn(btn)} disabled={!!loadingId}
            ...
            <div style={{ padding: '10px 18px 0', flexShrink: 0 }}>
              <button
                onClick={handleSave} disabled={!!loadingId}
