    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', background: 'rgba(0,0,0,0.9)', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <h2 style={{ color: '#fff', fontSize: 16, fontWeight: 700, letterSpacing: '-0.01em' }}>Share Post</h2>
          <div style={{ width: 72 }} />
        </div>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', width: '100%', maxWidth: '600px', margin: '0 auto' }}>
          ...
          >
            ...
            <h2 style={{ color: '#fff', fontSize: 24, fontWeight: 900, marginBottom: 16, letterSpacing: '-0.02em', lineHeight: 1.3 }}>
              {post.content?.substring(0, 60) || 'Post'}
            </h2>

            {post.weight && (
              <div style={{ marginBottom: 20 }}>
                <p style={{ color: '#60a5fa', fontSize: 22, fontWeight: 900, lineHeight: 1 }}>{post.weight}</p>
                <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11, fontWeight: 600, marginTop: 4, textTransform: 'uppercase', letterSpacing: '0.08em' }}>Weight</p>
              </div>
            )}
