          ...
          {post.weight && (
            <span className="block mt-1 text-blue-400 font-semibold">
              ...
              <motion.button
                ...
                className="absolute bottom-7 left-4 transition-all flex items-center gap-1"
                ...
                {hasReacted ? (
                  userStreakVariant === 'sunglasses' ? (
                    <div className="relative w-12 h-12">
                      <Flame className="w-12 h-12 text-orange-500 fill-current stroke-black stroke-1" />
                      <svg 
                        className="absolute inset-0 w-full h-full pointer-events-none"
                        viewBox="0 0 64 64"
                      >
                        <circle cx="20" cy="24" r="6" fill="none" stroke="black" strokeWidth="1" />
                        <circle cx="44" cy="24" r="6" fill="none" stroke="black" strokeWidth="1" />
                        <line x1="26" y1="24" x2="38" y2="24" stroke="black" strokeWidth="1" />
                      </svg>
                    </div>
                    ...
                    <div className="relative w-12 h-12">
                      ...
                      >
                        <path 
                          ...
                          strokeWidth="1"
                        />
                        <ellipse cx="32" cy="28" rx="24" ry="6" fill="currentColor" className="text-amber-700" stroke="black" strokeWidth="1" />
                        <rect x="14" y="26" width="36" height="1.5" fill="currentColor" className="text-amber-900" stroke="black" strokeWidth="1" />
                      </svg>
                    </div>
                  ) : (
                    <Flame className="w-12 h-12 text-orange-500 fill-current stroke-black stroke-1" />
                  ...
                  <Flame className="w-12 h-12 text-slate-400 opacity-40 stroke-black stroke-1" />
                )}
              </motion.button>
              )}
