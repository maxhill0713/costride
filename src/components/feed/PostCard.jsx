              ...
              {Object.keys(post.reactions || {}).length > 0 && (
                ...
                >
                  <div className="flex items-center">
                    ...
                    {Object.keys(post.reactions || {}).length > 4 && (
                      <span className="text-xs font-bold text-slate-300 ml-1">+{Object.keys(post.reactions || {}).length - 4}</span>
                    )}
                  </div>
                </button>
              )}
