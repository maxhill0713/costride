  ...
  const strengthTrends = useMemo(() => {
    ...
    Object.values(exerciseProgress).forEach((weights) => {
      ...
      if (recent.length && older.length) {
        ...
        if (recentAvg > olderAvg * 1.05) improving++;else
        if (recentAvg < olderAvg * 0.95) declining++;else
        maintaining++;
      }
    });
        ...
        <div className="flex items-center gap-2 mb-4">
          <Tabs value={viewMode} onValueChange={setViewMode} className="flex-1">
            <TabsList className="grid w-full grid-cols-3 bg-slate-800/50 p-1 rounded-lg">
              <TabsTrigger value="overview" className="inline-flex items-center justify-center whitespace-nowrap rounded-xl px-3 py-1 font-extrabold ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-xs transition-all duration-150 text-slate-400 hover:text-slate-600 hover:bg-slate-100 data-[state=active]:bg-cyan-500 data-[state=active]:text-white data-[state=active]:border-b-[4px] data-[state=active]:border-x-[1px] data-[state=active]:border-t-[1px] data-[state=active]:border-cyan-800 data-[state=active]:shadow-[0_4px_0_0_#0369a1,0_6px_0_0_#0e4a5c,0_8px_20px_rgba(6,100,200,0.4)] data-[state=active]:translate-y-0 active:translate-y-[4px] active:shadow-[0_0px_0_0_#0369a1] active:scale-95 data-[state=active]:scale-105">Overview</TabsTrigger>
              <TabsTrigger value="exercises" className="inline-flex items-center justify-center whitespace-nowrap rounded-xl px-3 py-1 font-extrabold ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-xs transition-all duration-150 text-slate-400 hover:text-slate-600 hover:bg-slate-100 data-[state=active]:bg-gradient-to-r data-[state=active]:from-cyan-500 data-[state=active]:to-blue-500 data-[state=active]:text-white data-[state=active]:border-b-[4px] data-[state=active]:border-x-[1px] data-[state=active]:border-t-[1px] data-[state=active]:border-cyan-800 data-[state=active]:shadow-[0_4px_0_0_#0369a1,0_6px_0_0_#0e4a5c,0_8px_20px_rgba(6,100,200,0.4)] data-[state=active]:translate-y-0 active:translate-y-[4px] active:shadow-[0_0px_0_0_#0369a1] active:scale-95 data-[state=active]:scale-105">Exercises</TabsTrigger>
              <TabsTrigger value="records" className="inline-flex items-center justify-center whitespace-nowrap rounded-xl px-3 py-1 font-extrabold ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-xs transition-all duration-150 text-slate-400 hover:text-slate-600 hover:bg-slate-100 data-[state=active]:bg-gradient-to-r data-[state=active]:from-cyan-500 data-[state=active]:to-blue-500 data-[state=active]:text-white data-[state=active]:border-b-[4px] data-[state=active]:border-x-[1px] data-[state=active]:border-t-[1px] data-[state=active]:border-cyan-800 data-[state=active]:shadow-[0_4px_0_0_#0369a1,0_6px_0_0_#0e4a5c,0_8px_20px_rgba(6,100,200,0.4)] data-[state=active]:translate-y-0 active:translate-y-[4px] active:shadow-[0_0px_0_0_#0369a1] active:scale-95 data-[state=active]:scale-105">Records</TabsTrigger>
            </TabsList>
          </Tabs>
