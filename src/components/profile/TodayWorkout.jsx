            ...
            <div className="fixed bottom-20 left-1/2 -translate-x-1/2 z-40">
              <div className="relative w-20 h-20">
                ...
                <svg className="absolute inset-0 w-full h-full -rotate-90" viewBox="0 0 100 100">
                  <circle cx="50" cy="50" r="45" fill="none" stroke="rgba(51, 65, 85, 0.3)" strokeWidth="2" />
                  <circle
                    cx="50"
                    cy="50"
                    r="45"
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-lg font-black text-orange-500">{formatTime(restTimer)}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-center mt-4 pt-3 border-t border-slate-700/50">
            {!isTimerActive ? (
              <Button
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-lg px-4 h-8 text-xs shadow-lg"
              >
              ...
              <Button
                ...
                className="flex items-center gap-2 bg-slate-700 hover:bg-slate-600 text-white font-semibold rounded-lg px-4 h-8 text-xs"
              >
