    ...
    >
      <div className={isExpanded ? "space-y-3 mb-4" : "space-y-2"}>
         <div className={`flex items-center justify-between ${isExpanded ? 'gap-3' : 'gap-2'}`}>
          ...
          <h2 className={`font-black bg-gradient-to-r from-orange-300 to-orange-200 bg-clip-text text-transparent tracking-tight truncate ${isExpanded ? 'text-2xl' : 'text-xl'}`}>
