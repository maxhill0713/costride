      ...
      {isExpanded && todayWorkout.exercises && todayWorkout.exercises.length > 0 ? (
        <div className="space-y-2">
          ...
          {todayWorkout.exercises.map((exercise, index) => (
            <div key={index} className={`p-3 bg-white/5 backdrop-blur-md rounded-xl border border-white/10 shadow-lg shadow-black/10 ${editingIndex === index ? 'block' : 'grid grid-cols-[1fr_auto_auto_auto] gap-2 items-center'} hover:border-white/20 transition-all w-[105%] mx-auto`}>
              {editingIndex === index ? (
                ...
                <>
                  ...
                  <div className="text-xs font-semibold text-slate-300 bg-white/10 px-2 py-1 rounded-lg text-center min-w-[65px]">
                    {exercise.setsReps || '-'}
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-2">
                        <div className="text-sm font-black text-white bg-gradient-to-r from-orange-500/80 to-orange-600/80 px-2.5 py-1 rounded-lg shadow-md shadow-orange-500/10 min-w-[65px] text-center">
                          {exercise.weight || '-'}
                    ...
                    <Button
                      ...
                      size="icon"
                      variant="ghost"
                      className="w-6 h-6 text-slate-400 hover:text-orange-400 hover:bg-orange-500/10 transition-all shrink-0 ml-auto -mr-1"
                    >
