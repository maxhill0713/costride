...
// ── Challenge catalogue ───────────────────────────────────────────────────────
const CATEGORIES = [
  { value: 'lifting',    label: 'Lifting',    emoji: '🏋️', color: T.purple,  desc: 'Track weight lifted'      },
  { value: 'attendance', label: 'Attendance', emoji: '📍', color: T.blue,    desc: 'Most check-ins wins'      },
  { value: 'streak',     label: 'Streak',     emoji: '🔥', color: T.amber,   desc: 'Longest consecutive days' },
  { value: 'cardio',     label: 'Cardio',     emoji: '🏃', color: T.green,   desc: 'Distance or time tracked' },
];
