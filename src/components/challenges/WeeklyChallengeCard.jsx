        ...
        <div className="relative p-4 space-y-3">
          ...
          style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)' }}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[13px] font-black text-white truncate">{challenge.id === 'discipline_builder' ? '1 x Beach Day Streak Icon Design' : challenge.reward || 'Weekly Challenge Badge'}</p>
            </div>
          </div>
