...
function Tab3D({ tab, active, onClick }) {
  ...
  const INACTIVE = 'bg-slate-900/80 text-slate-400 border-slate-600/40 shadow-[0_5px_0_0_#172033,0_8px_20px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.12)]';

  const ACTIVE = {
    weekly:    'bg-gradient-to-b from-purple-400 via-purple-500 to-purple-600 text-white border-transparent shadow-[0_5px_0_0_#4c1d95,0_8px_20px_rgba(139,92,246,0.45),inset_0_1px_0_rgba(255,255,255,0.2),inset_0_0_20px_rgba(255,255,255,0.05)]',
    community: 'bg-gradient-to-b from-blue-400 via-blue-500 to-blue-700 text-white border-transparent shadow-[0_5px_0_0_#1e3a8a,0_8px_20px_rgba(59,130,246,0.4),inset_0_1px_0_rgba(255,255,255,0.2),inset_0_0_20px_rgba(255,255,255,0.05)]',
    rewards:   'bg-gradient-to-b from-amber-400 via-amber-500 to-amber-600 text-white border-transparent shadow-[0_5px_0_0_#92400e,0_8px_20px_rgba(251,191,36,0.4),inset_0_1px_0_rgba(255,255,255,0.2),inset_0_0_20px_rgba(255,255,255,0.05)]',
  };
  ...
  return (
    <button
      ...
      className={`
        ...
        px-3 py-5 rounded-2xl font-bold
        border backdrop-blur-md
        transition-all duration-100 transform-gpu
        active:shadow-none active:translate-y-[5px] active:scale-95
        focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50
        ${active ? ACTIVE[tab.id] : INACTIVE}
      `}
    >
      <Icon
        className="w-5 h-5"
        strokeWidth={active ? 2.5 : 2}
        style={{ filter: active ? `drop-shadow(0 0 6px rgba(${tab.accentRgb},0.6))` : 'none' }}
      />
