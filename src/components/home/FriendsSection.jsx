      ...
      <AnimatePresence>
        ...
        <>
            ...
            exit="exit">
              ...
              <div className="w-11/12 max-w-2xl mt- h-[50vh] flex flex-col bg-slate-900/60 backdrop-blur-md border border-slate-700/20 rounded-3xl shadow-2xl shadow-black/20 text-white overflow-hidden">
      ...
      <AnimatePresence>
        ...
        <>
            ...
            exit="exit">
              ...
              <div className="w-11/12 max-w-2xl mt-4 h-[50vh] flex flex-col bg-slate-900/60 backdrop-blur-md border border-slate-700/20 rounded-3xl shadow-2xl shadow-black/20 text-white overflow-hidden">
                <div className="px-3 py-1 flex items-center gap-1">
                  <div className="relative flex-1">
