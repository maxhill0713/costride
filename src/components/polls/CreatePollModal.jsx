...
const S = `
  ...
  .pl-inp:focus{border-color:rgba(139,92,246,0.5);}
  ...
  return (
    <button onClick={onClick} disabled={disabled}
      ...
      style={{
        ...
        background: disabled ? 'rgba(255,255,255,0.05)' : secondary ? 'rgba(255,255,255,0.05)' : 'linear-gradient(180deg,#8b5cf6 0%,#7c3aed 50%,#6d28d9 100%)',
        ...
        borderBottom: secondary || disabled ? '3px solid rgba(0,0,0,0.3)' : p ? '1px solid #3b0764' : '4px solid #3b0764',
        boxShadow: !secondary && !disabled && !p ? '0 3px 0 rgba(0,0,0,0.4),0 6px 20px rgba(139,92,246,0.3),inset 0 1px 0 rgba(255,255,255,0.2)' : 'none',
