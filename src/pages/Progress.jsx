  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(to bottom right, #02040a, #0d2360, #02040a)' }}>
      ...
      <Tabs defaultValue="analytics" className="w-full">
        ...
        {/* ── Analytics ── */}
        <TabsContent value="analytics" className="mt-0 px-3 md:px-4 py-5 pb-24 md:pb-5">
          <div className="max-w-4xl mx-auto">
        ...
        {/* ── Targets ── */}
        <TabsContent value="goals" className="mt-0 px-3 md:px-4 py-5 pb-24 md:pb-5">
        ...
        {/* ── Nutrition ── */}
        <TabsContent value="nutrition" className="mt-0 px-3 md:px-4 py-5 pb-24 md:pb-5">
          <div className="max-w-4xl mx-auto">
            <NutritionTab />
          </div>
        </TabsContent>
        ...
        {/* ── Trainer ── */}
        <TabsContent value="rank" className="mt-0 px-3 md:px-4 py-5 pb-24 md:pb-5">
          <div className="max-w-4xl mx-auto">
