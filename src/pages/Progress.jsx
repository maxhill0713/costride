  ...
  if (!currentUser) {
    return (
      <div className="min-h-screen" style={{ backgroundColor: 'transparent' }}>
        ...
        <div className="fixed top-0 left-0 right-0 z-20 bg-slate-900/95 border-b-2 border-blue-700/40 px-3 md:px-4 pb-4" style={{ paddingTop: 'calc(1.5rem + env(safe-area-inset-top))' }}>
