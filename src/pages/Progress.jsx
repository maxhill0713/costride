  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(to bottom right, #02040a, #0d2360, #02040a)' }}>
      ...
      <Tabs defaultValue="analytics" className="w-full">
        ...
        <TabsContent value="analytics" className="mt-0 px-3 md:px-4 pt-8 pb-[130px] md:pb-5">
          <div className="max-w-4xl mx-auto">
            <AnalyticsTab currentUser={currentUser} workoutLogs={workoutLogs} checkIns={checkIns} animateCharts={analyticsAnimKey} />
          </div>
        </TabsContent>

        <TabsContent value="goals" className="mt-0 px-3 md:px-4 pt-8 pb-[130px] md:pb-5">
          <div className="max-w-4xl mx-auto">
            <TargetsTab currentUser={currentUser} />
          </div>
        </TabsContent>

        <TabsContent value="nutrition" className="mt-0 px-3 md:px-4 pt-8 pb-[130px] md:pb-5">
          <div className="max-w-4xl mx-auto">
            <NutritionTab />
          </div>
        </TabsContent>
