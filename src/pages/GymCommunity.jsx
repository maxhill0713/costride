  ...
  return (
    <PullToRefresh onRefresh={async () => { await queryClient.invalidateQueries(); }}>
      <div className="min-h-screen bg-[linear-gradient(to_bottom_right,#02040a,#0d2360,#02040a)]">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full overflow-x-hidden">
          <div className="relative overflow-hidden">
            ...
            <div className="relative z-10 pt-1" style={{ borderBottom:'1px solid rgba(255,255,255,0.07)' }}>
              <TabsList className="flex justify-between bg-transparent px-2 py-1 h-auto gap-0.5 w-full" style={{ width:'100%' }}>
                ...
                <TabsTrigger value="classes"    className={tabTriggerClass}><span>Classes</span></TabsTrigger>
              </TabsList>
            </div>
          </div>
        ...
        <CoachProfileModal coach={selectedCoach} open={!!selectedCoach} onClose={() => setSelectedCoach(null)} />
      </div>
    </PullToRefresh>
  );
}