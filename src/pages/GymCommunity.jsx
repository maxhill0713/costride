    ...
    <PullToRefresh onRefresh={async () => {
      ...
      <div className="max-w-4xl mx-auto px-2 md:px-4 py-2 md:py-4 pb-24 w-full overflow-hidden">
        ...
        <TabsContent value="home" className="space-y-2 md:space-y-3 mt-0 w-full overflow-hidden">
          ...
          {/* Leaderboard Section */}
          <Card className="bg-slate-900/50 backdrop-blur-2xl border border-white/20 p-3 md:p-5 shadow-2xl shadow-black/20 transition-all duration-300">
        ...
        <TabsContent value="challenges" className="space-y-2 md:space-y-4 mt-0 w-full overflow-hidden">
          ...
          {/* Leaderboard Section */}
          <Card className="bg-gradient-to-br from-slate-900/70 via-slate-900/60 to-slate-950/70 backdrop-blur-2xl border border-white/20 p-3 md:p-5 shadow-2xl shadow-black/20 transition-all duration-300">
            <div className="flex items-center justify-between mb-2 md:mb-4">
              <h3 className="text-base md:text-lg font-bold text-white flex items-center gap-2">
                <Trophy className="w-5 h-5 text-cyan-400" />
                Community Leaderboard
        ...
        <TabsContent value="events" className="space-y-2 md:space-y-3 mt-0 w-full overflow-hidden">
          {/* Classes Section */}
          <Card className="bg-gradient-to-br from-slate-900/70 via-slate-900/60 to-slate-950/70 backdrop-blur-2xl border border-white/20 p-2 md:p-5 shadow-2xl shadow-black/20">
            <div className="flex items-center justify-between mb-2 md:mb-4">
