        ...
        <div className="max-w-4xl mx-auto px-4 py-2 space-y-3">
          ...
          {featuredChallenge && (
            <Link to={createPageUrl('RedeemReward') + '?tab=challenges'} className="block">
              <Card className="bg-gradient-to-br from-slate-900/70 via-slate-900/60 to-slate-950/70 backdrop-blur-[100px] border border-blue-500/40 hover:border-blue-400/50 transition-all cursor-pointer shadow-2xl shadow-black/20 rounded-2xl overflow-hidden group">
