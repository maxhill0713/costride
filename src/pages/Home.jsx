  ...
  return (
    <PullToRefresh onRefresh={async () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        {/* Header with Streak */}
        <div className="bg-gradient-to-b from-slate-950/95 via-blue-950/90 to-transparent backdrop-blur-xl border-b border-blue-900/60 px-4 py-3 shadow-xl shadow-black/30">
        ...
        <div className="max-w-4xl mx-auto px-4 py-3 space-y-4">
          ...
          {featuredChallenge && (
            <Link to={createPageUrl('RedeemReward') + '?tab=challenges'} className="block">
              <Card className="bg-gradient-to-br from-slate-900/70 via-slate-900/60 to-slate-950/70 backdrop-blur-xl border border-blue-500/30 hover:border-blue-400/50 transition-all cursor-pointer shadow-2xl shadow-black/20 rounded-2xl overflow-hidden group">
                <div className="relative p-4">
                  <div className="flex items-start justify-between gap-3 mb-4">
                    <div className="flex items-center gap-2">
                      <Trophy className="w-5 h-5 text-amber-400" />
                      <h3 className="text-base font-bold bg-gradient-to-r from-amber-300 to-yellow-300 bg-clip-text text-transparent tracking-tight">Weekly Challenges</h3>
                    </div>
