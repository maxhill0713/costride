          ...
          {memberGym && (
            <>
              ...
              <div className="bg-slate-800/40 rounded-xl px-4 py-3 border border-slate-700/30">
                <p className="text-slate-300 text-xs font-medium tracking-tight mb-3">{todayCheckIns.length > 0 ? `${todayCheckIns.length} members checked in today` : '3 members checked in today'}</p>
