...
export default function Home() {
  ...
  if (userLoading || !currentUser) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[linear-gradient(to_bottom_right,#02040a,#0c1c4a,#02040a)]">
  ...
  return (
    <PullToRefresh onRefresh={async () => { await queryClient.invalidateQueries(); }}>
      <div className="min-h-screen bg-[linear-gradient(to_bottom_right,#02040a,#0c1c4a,#02040a)]">

        {/* Header */}
        <div className="bg-gradient-to-b from-slate-900/60 to-transparent backdrop-blur-sm border-b border-slate-800/50 px-4 py-3">
