...
return (
<div className="min-h-screen flex items-center justify-center bg-[linear-gradient(to_bottom_right,#02040a,#0d255c,#02040a)]">
...
<div className="min-h-screen bg-[linear-gradient(to_bottom_right,#02040a,#0d255c,#02040a)]">
