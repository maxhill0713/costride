...
export default function Home() {
  ...
  if (userLoading || !currentUser) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-925 via-blue-925 to-slate-925 flex items-center justify-center">
  ...
  return (
    <PullToRefresh onRefresh={async () => { await queryClient.invalidateQueries(); }}>
      <div className="min-h-screen bg-gradient-to-br from-slate-925 via-blue-925 to-slate-925">
