  ...
  return (
    <PullToRefresh onRefresh={async () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        <div className={`max-w-4xl mx-auto px-4 py-2 ${daysSinceCheckIn === 0 ? 'space-y-2' : 'space-y-3'}`}>
              ...
              {currentUser?.custom_workout_types ? (
                <>
                  ...
                  <button
                    ...
                    className="w-full mt-2 p-2 rounded-lg bg-red-500/20 border border-red-500/40 text-red-400 text-xs font-semibold hover:bg-red-500/30 transition-all"
                  >
