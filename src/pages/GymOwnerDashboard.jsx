...
export default function GymOwnerDashboard() {
  ...
  if (myGyms.length===0) return <Splash><Dumbbell style={{width:28,height:28,color:'#38bdf8',margin:'0 auto 12px'}}/><h2 style={{color:'#f1f5f9',fontWeight:900,marginBottom:8}}>{isCoach ? 'Not Assigned to a Gym' : 'No Gyms'}</h2><p style={{color:'#5a7a96',fontSize:13,marginBottom:20}}>{isCoach ? 'Ask your gym owner to add you as a coach.' : 'Register your gym to get started.'}</p>{!isCoach && <Link to={createPageUrl('GymSignup')}><button style={{background:'linear-gradient(135deg,#0ea5e9,#06b6d4)',color:'#fff',border:'none',borderRadius:10,padding:'9px 20px',fontWeight:700,cursor:'pointer'}}>Register Your Gym</button></Link>}<Link to={createPageUrl('Home')}><button style={{background:'rgba(255,255,255,0.07)',color:'#f1f5f9',border:'1px solid rgba(255,255,255,0.1)',borderRadius:10,padding:'9px 20px',fontWeight:700,cursor:'pointer',marginTop:8}}>Back to Home</button></Link></Splash>;
