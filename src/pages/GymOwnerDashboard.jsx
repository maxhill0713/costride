...
function _DELETED_TabCoachOverview_STUB() {
  ...
  const recentFeed = [...checkIns].slice(0, 10).map(c => ({
    name: c.user_name || 'Member', user_id: c.user_id, time: c.check_in_date,
  }));

  // This week's top members by check-ins
  ...
  // Class fill rate for each class this week
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: 18, alignItems: 'start' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          {/* My Classes with capacity fill bars */}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
            <CoachCard accent="#ef4444" title="At-Risk Members" action={atRisk.length > 0 ? `${atRisk.length}` : undefined}>
