    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 pb-24">
      <div className="max-w-6xl mx-auto px-3 md:px-4 py-4">
        <div className="mb-6 grid grid-cols-3 gap-3">
          <button
            onClick={() => setActiveSection('weekly')} className="px-3 md:px-6 py-5 rounded-2xl font-bold text-base md:text-lg\ntransition-all duration-150 ease-out\nflex flex-col items-center gap-2\ntransform-gpu text-white border\n\n/* DEFAULT (glass grey) */\nbg-white/10\nbackdrop-blur-xl\nborder-white/20\ntext-slate-300\nshadow-[0_8px_20px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.25)]\nhover:bg-white/15\nhover:text-white\n\n/* INSTANT PURPLE ON PRESS */\nactive:bg-gradient-to-b\nactive:from-purple-400\nactive:via-purple-500\nactive:to-purple-600\nactive:border-slate-500/50\nactive:shadow-none\nactive:translate-y-[3px]\nactive:scale-95\nactive:text-white\n\n/* STAYS PURPLE WHEN ACTIVE */\ndata-[state=active]:bg-gradient-to-b\ndata-[state=active]:from-purple-400\ndata-[state=active]:via-purple-500\ndata-[state=active]:to-purple-600\ndata-[state=active]:border-slate-500/50\ndata-[state=active]:shadow-[0_3px_0_0_#5b21b6,0_8px_20px_rgba(120,40,220,0.4),inset_0_1px_0_rgba(255,255,255,0.2),inset_0_0_20px_rgba(255,255,255,0.05)]\ndata-[state=active]:scale-105">
