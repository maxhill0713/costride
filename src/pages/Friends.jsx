    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto max-w-2xl mx-auto w-full px-4 py-6">
        ...
        <>
            ...
            <div className="fixed left-1/2 -translate-x-1/2 top-16 w-11/12 max-w-2xl h-1/2 z-[9999] flex flex-col bg-slate-900/60 backdrop-blur-md border border-slate-700/20 rounded-3xl shadow-2xl shadow-black/20 text-white">
