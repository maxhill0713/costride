...
export default function PrivacySettings() {
  ...
  if (!currentUser) return <SettingsSubPageShell title="Privacy"><p style={{ color: '#475569', textAlign: 'center', paddingTop: 40 }}>Loading…</p></SettingsSubPageShell>;

  return (
    <SettingsSubPageShell title="Privacy">
