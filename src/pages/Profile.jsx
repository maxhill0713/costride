        ...
        <div className="w-full bg-slate-900/40 border-b border-slate-700/50 sticky top-0 z-40">
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            <TabsList className="grid grid-cols-4 w-full bg-transparent backdrop-blur-0 border-0 p-0 rounded-none gap-0">
              <TabsTrigger value="stats" className="rounded-lg rounded-l-xl flex items-center justify-center font-semibold bg-slate-800/40 text-slate-400 data-[state=active]:bg-blue-500 data-[state=active]:border data-[state=active]:border-blue-500 data-[state=active]:text-white transition-all text-sm px-3 py-2 outline-none">
                Insights
              </TabsTrigger>
              <TabsTrigger value="progress" className="rounded-lg flex items-center justify-center font-semibold bg-slate-800/40 text-slate-400 data-[state=active]:bg-blue-500 data-[state=active]:border data-[state=active]:border-blue-500 data-[state=active]:text-white transition-all text-sm px-3 py-2 outline-none">
                Progress
              </TabsTrigger>
              <TabsTrigger value="goals" className="rounded-lg flex items-center justify-center font-semibold bg-slate-800/40 text-slate-400 data-[state=active]:bg-blue-500 data-[state=active]:border data-[state=active]:border-blue-500 data-[state=active]:text-white transition-all text-sm px-3 py-2 outline-none">
                Goals
              </TabsTrigger>
              <TabsTrigger value="posts" className="rounded-lg rounded-r-xl flex items-center justify-center font-semibold bg-slate-800/40 text-slate-400 data-[state=active]:bg-blue-500 data-[state=active]:border data-[state=active]:border-blue-500 data-[state=active]:text-white transition-all text-sm px-3 py-2 outline-none">
                Posts
              </TabsTrigger>
            </TabsList>
          </div>
