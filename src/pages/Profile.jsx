    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <div className="w-full bg-gradient-to-b from-slate-900/60 to-slate-950/40 border-b border-slate-700/50 sticky top-0 z-40 backdrop-blur-md">
          <TabsList className="grid grid-cols-4 w-full bg-transparent backdrop-blur-0 border-0 p-0 rounded-none gap-0">
            <TabsTrigger value="stats" className="bg-slate-700/50 text-slate-300 font-bold rounded-full px-3 py-1.5 flex items-center gap-2 justify-center border border-slate-500 shadow-[0_6px_0_0_#1e293b,0_8px_20px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.1)] data-[state=active]:bg-gradient-to-b data-[state=active]:from-blue-500 data-[state=active]:via-blue-600 data-[state=active]:to-blue-700 data-[state=active]:text-white data-[state=active]:border-transparent data-[state=active]:shadow-[0_6px_0_0_#1a3fa8,0_8px_20px_rgba(0,0,100,0.5),inset_0_1px_0_rgba(255,255,255,0.15)] active:shadow-none active:translate-y-[6px] active:scale-95 transition-all duration-100 text-xs transform-gpu">
              Insights
            </TabsTrigger>
            <TabsTrigger value="progress" className="bg-slate-700/50 text-slate-300 font-bold rounded-full px-3 py-1.5 flex items-center gap-2 justify-center border border-slate-500 shadow-[0_6px_0_0_#1e293b,0_8px_20px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.1)] data-[state=active]:bg-gradient-to-b data-[state=active]:from-blue-500 data-[state=active]:via-blue-600 data-[state=active]:to-blue-700 data-[state=active]:text-white data-[state=active]:border-transparent data-[state=active]:shadow-[0_6px_0_0_#1a3fa8,0_8px_20px_rgba(0,0,100,0.5),inset_0_1px_0_rgba(255,255,255,0.15)] active:shadow-none active:translate-y-[6px] active:scale-95 transition-all duration-100 text-xs transform-gpu">
              Split
            </TabsTrigger>
            <TabsTrigger value="goals" className="bg-slate-700/50 text-slate-300 font-bold rounded-full px-3 py-1.5 flex items-center gap-2 justify-center border border-slate-500 shadow-[0_6px_0_0_#1e293b,0_8px_20px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.1)] data-[state=active]:bg-gradient-to-b data-[state=active]:from-blue-500 data-[state=active]:via-blue-600 data-[state=active]:to-blue-700 data-[state=active]:text-white data-[state=active]:border-transparent data-[state=active]:shadow-[0_6px_0_0_#1a3fa8,0_8px_20px_rgba(0,0,100,0.5),inset_0_1px_0_rgba(255,255,255,0.15)] active:shadow-none active:translate-y-[6px] active:scale-95 transition-all duration-100 text-xs transform-gpu">
              Goals
            </TabsTrigger>
            <TabsTrigger value="posts" className="bg-slate-700/50 text-slate-300 font-bold rounded-full px-3 py-1.5 flex items-center gap-2 justify-center border border-slate-500 shadow-[0_6px_0_0_#1e293b,0_8px_20px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.1)] data-[state=active]:bg-gradient-to-b data-[state=active]:from-blue-500 data-[state=active]:via-blue-600 data-[state=active]:to-blue-700 data-[state=active]:text-white data-[state=active]:border-transparent data-[state=active]:shadow-[0_6px_0_0_#1a3fa8,0_8px_20px_rgba(0,0,100,0.5),inset_0_1px_0_rgba(255,255,255,0.15)] active:shadow-none active:translate-y-[6px] active:scale-95 transition-all duration-100 text-xs transform-gpu">
              Posts
            </TabsTrigger>
          </TabsList>
        </div>
