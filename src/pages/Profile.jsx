...
import { Settings, TrendingUp, Award, Calendar, Dumbbell, Target, Share2, MapPin, Edit2, Save, X, Plus, Flame, Trophy, AlertCircle, Building2, CheckCircle, Camera, FileText, BarChart3, Image as ImageIcon, Video, Upload, Zap } from 'lucide-react';
            ...
            <div className="flex items-center gap-5 flex-1">
              ...
              <div className="flex-1">
               <div className="flex items-center gap-3 mb-2">
                  <h1 className="text-2xl md:text-3xl font-medium tracking-[-0.02em] text-white leading-tight truncate">{currentUser.full_name}</h1>
