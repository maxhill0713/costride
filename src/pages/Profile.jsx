      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <div className="w-full bg-gradient-to-b from-slate-900/60 to-slate-950/40 border-b border-slate-700/50 sticky top-0 z-40 backdrop-blur-md">
          <TabsList className="grid grid-cols-4 w-full bg-transparent backdrop-blur-0 border-0 p-0 rounded-none gap-0">
            <TabsTrigger value="stats" className="bg-gradient-to-b text-white mx-1 px-3 py-1.5 text-xs font-bold rounded-full from-blue-500 via-blue-600 to-blue-700 flex items-center gap-2 justify-center shadow-[0_4px_0_0_#1a3fa8,0_6px_10px_rgba(0,0,100,0.4)] active:shadow-[0_1px_0_0_#1a3fa8] active:translate-y-[3px] transition-all duration-100">
              Insights
            </TabsTrigger>
            <TabsTrigger value="progress" className="bg-gradient-to-b text-white mx-1 px-3 py-1.5 text-xs font-bold rounded-full from-blue-500 via-blue-600 to-blue-700 flex items-center gap-2 justify-center shadow-[0_4px_0_0_#1a3fa8,0_6px_10px_rgba(0,0,100,0.4)] active:shadow-[0_1px_0_0_#1a3fa8] active:translate-y-[3px] transition-all duration-100">
              Split
            </TabsTrigger>
            <TabsTrigger value="goals" className="bg-gradient-to-b text-white mx-1 px-3 py-1.5 text-xs font-bold rounded-full from-blue-500 via-blue-600 to-blue-700 flex items-center gap-2 justify-center shadow-[0_4px_0_0_#1a3fa8,0_6px_10px_rgba(0,0,100,0.4)] active:shadow-[0_1px_0_0_#1a3fa8] active:translate-y-[3px] transition-all duration-100">
              Goals
            </TabsTrigger>
            <TabsTrigger value="posts" className="bg-gradient-to-b text-white mx-1 px-3 py-1.5 text-xs font-bold rounded-full from-blue-500 via-blue-600 to-blue-700 flex items-center gap-2 justify-center shadow-[0_4px_0_0_#1a3fa8,0_6px_10px_rgba(0,0,100,0.4)] active:shadow-[0_1px_0_0_#1a3fa8] active:translate-y-[3px] transition-all duration-100">
              Posts
            </TabsTrigger>
          </TabsList>
        </div>
