      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <div className="w-full bg-gradient-to-b from-slate-900/60 to-slate-950/40 border-b border-slate-700/50 sticky top-0 z-40 backdrop-blur-md">
          <TabsList className="grid grid-cols-4 w-full bg-transparent backdrop-blur-0 border-0 p-0 rounded-none gap-0">
            ...
            <TabsTrigger value="progress" className="bg-cyan-400 text-black font-bold rounded-full px-6 py-4 flex items-center gap-2 w-full justify-center active:scale-95 transition-all duration-150 shadow-[0_6px_0_0_#0891b2] active:shadow-[0_2px_0_0_#0891b2] active:translate-y-1\n">
              Split
            </TabsTrigger>
